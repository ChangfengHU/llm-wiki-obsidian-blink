--- 
type: source
tags: [github, open-source, ai-tool, agent]
summary: HTML PPT Studio 是一个无需构建步骤的纯静态 HTML/CSS/JS 幻灯片制作引擎，同时也是专为 AI Agent 设计的技能库（AgentSkill），提供 24 主题、31 布局、20+ 动画。
...
## 适用场景
- AI 应用开发者：在开发“文本生成 PPT”类 AI 智能体时，将其作为底层的渲染引擎和 Prompt 目标格式。
