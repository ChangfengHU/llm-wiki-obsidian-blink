...
- [[wiki/sources/archon|archon]] — **项目主页**：
...
- [[wiki/sources/awesome-python|awesome-python]] — **项目主页**：
...
- [[wiki/sources/papers-we-love|papers-we-love]] — "社区驱动的经典计算机科学论文精选与讨论目录，强调高信噪比阅读和长期知识沉淀。"
...
- [[wiki/entities/awesome-python|awesome-python]] — **项目主页**：
...
- [[wiki/entities/maigret|maigret]] — 🎯 **一句话定位**
...
## Comparisons
- [[wiki/comparisons/开源ai工具项目横向比较|开源ai工具项目横向比较]] — "比较当前 raw 资料中的开源 AI/自动化工具定位、输入输出和适用场景。"
- [[wiki/comparisons/视频内容自动化工具对比|视频内容自动化工具对比]] — "对比 Pixelle-Video、autoclip、openscreen 在视频生成、二创和录屏美化上的差异。"
