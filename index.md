...
- [[wiki/overview/知识图谱关系|知识图谱关系]] — 实体、概念和来源之间的边列表。
- [[README]] — 项目说明：基于 Andrej Karpathy LLM Wiki 模式的 Obsidian 知识管理系统。
- [[TheSchema]] — 现有仓库规则：`raw/` 只读，`wiki/` 由 agent 维护。

## Sources
- [[wiki/sources/ai-trend-analysis-20260506-160559|ai-trend-analysis-20260506-160559]] — 
...
- [[wiki/sources/awesome-go|awesome-go]] — Go 语言生态的精选框架、库与软件导航列表，强调社区维护与自动化质量校验。
...
- [[wiki/sources/recursion-guard-test-20260506-155321|recursion-guard-test-20260506-155321]] — 
...
- [[wiki/entities/awesome-go|awesome-go]] — Go 语言生态的高质量开源项目索引，支持技术选型、生态探索和列表工程化维护。
...
- [[wiki/entities/hellogithub|hellogithub]] — 以月刊形式聚合 GitHub 入门开源项目的高影响力内容型仓库。
...
- [[wiki/entities/recursion-guard-test-20260506-155321|recursion-guard-test-20260506-155321]] — 
...
- [[wiki/concepts/llm-应用开发平台|LLM 应用开发平台]] — 用于构建 Agent、RAG、工作流和生产级 LLM 应用的低代码/可视化平台。
- [[wiki/concepts/markdown-发布排版|Markdown 发布排版]] — 把 Markdown 内容转换为目标平台可接受的富文本/HTML/样式格式。
- [[wiki/concepts/个人自动化|个人自动化]] — 用脚本、桌面工具或 Agent 自动化个人高频任务。
- [[wiki/concepts/内容分发自动化|内容分发自动化]] — 自动把内容转换格式并分发到目标设备、渠道或平台。
- [[wiki/concepts/地图可视化组件|地图可视化组件]] — 地图 UI、地理数据渲染和 React 组件化封装。
- [[wiki/concepts/安全工具聚合|安全工具聚合]] — 把渗透测试/安全检测工具集中安装、分类和调用的工作流。
- [[wiki/concepts/开源工具目录|开源工具目录]] — 通过列表、导航或集成包组织开源工具，降低发现和调用成本。
- [[wiki/concepts/知识管理|知识管理]] — 围绕资料收集、结构化、复利式沉淀和可检索知识网络的实践。
- [[wiki/concepts/自主-agent-框架|自主 Agent 框架]] — 可跨平台接入、调用工具并在长期使用中沉淀技能和用户画像的 Agent 系统。
- [[wiki/concepts/自然语言图表生成|自然语言图表生成]] — 利用 LLM 将自然语言需求转换为架构图、流程图或可编辑图表。
- [[wiki/concepts/视频内容自动化|视频内容自动化]] — 将脚本、素材生成、录屏/剪辑、语义理解和发布流程自动化，降低视频创作与二创门槛。
- [[wiki/concepts/跨平台桌面集成|跨平台桌面集成]] — 在不同操作系统或桌面环境间桥接应用、录屏、远程桌面或本地体验。

## Comparisons
- [[wiki/comparisons/开源ai工具项目横向比较|开源 AI 工具项目横向比较]] — 比较当前 raw 资料中的开源 AI/自动化工具定位、输入输出和适用场景。
- [[wiki/comparisons/视频内容自动化工具对比|视频内容自动化工具对比]] — 对比 Pixelle-Video、autoclip、openscreen 的视频生成、二创和录屏美化差异。

## Queries
<!-- save=false 的查询不写入 queries/ -->
